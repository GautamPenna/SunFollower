 ...
 * (8) Otto Middle School - Latitude and Longitude Serve as Defualt Coordiantes
 * (9) I set November 14th as Defualt Day - and program executes in a rapid demo mode - for an OMS Setup.
 *  
 *  Uses:
 *  ============
...
#include <SoftwareSerial.h> // Include the software serial librar
...
void loop() {
  ...
  if (GPS.fix != 1) {
    ...
    Serial.println ("We are going use GPS Coordinates for OMS 33.005803 N, 96.6528103 W and run a DEMO!");
    Serial.println ("==================================================================================");
    ...
    display.println(" ");
    display.println ("Otto Middle School ");
    display.println(" ");
    display.println ("33.0058 N, 96.6528 W");
    display.display();
    delay(8000);
    Place = "Otto Middle School";
    latitude = 33.005803;
...
void gotBacktoAltHome() {
  ...
  Serial.print("This is the Max ALT Steps : ");
...
void gotBacktoAziHome() {
  ...
  Serial.print("This is the Max AZI Steps : ");
