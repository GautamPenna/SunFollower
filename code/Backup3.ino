...
void setup() { 
  ...
  Serial.begin(115200); // Serial moniter is set to 115200 baud rate
...
void loop() {
  ...
  The_First_Step_To_Two_Degrees = Total_Time/160;   
  Serial.print("Your first two is :  ");// Prints the statement to the Serial Moniter
  Serial.println(The_First_Step_To_Two_Degrees);// Prints the statement to the Serial Moniter

  The_Second_Step_To_Two_Degrees = 2*The_First_Step_To_Two_Degrees;
  Serial.print("Your second two is :  ");// Prints the statement to the Serial Moniter
  Serial.println(The_Second_Step_To_Two_Degrees_Degrees_Degrees);// Prints the statement to the Serial Moniter
  ...
  while (TotalTime_Number!= 0) { 
    ...
    if (sunriseMsecond = 60) {
      ...
      Serial.print("That was one day. Good Night");// Prints the statement to the Serial Moniter
    }
